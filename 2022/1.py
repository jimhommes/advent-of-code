...
current_sum = 0
top_three_highest_sums = [-1, -1, -1]

for line in lines:
    if line == '\n':
        if current_sum > min(top_three_highest_sums):
            top_three_highest_sums = put_in_top_three(current_sum, top_three_highest_sums)
        current_sum = 0
    else:
        current_sum += int(line)

print(sum(top_three_highest_sums))
